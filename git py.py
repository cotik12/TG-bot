...
class BiorhythmCompatibility:
    ...
    def calculate_compatibility(self) -> int:
        ...
        max_possible_difference = 7 * max(PHYSICAL_CONST, EMOTIONAL_CONST, INTELLIGENT_CONST, HEART_CONST,
                                          CREATIVE_CONST, INTUITIVE_CONST, HIGHER_CONST)
...
async def cmd_start(message: types.Message):
    await message.answer("Добро пожаловать!\n"
                         "Бот 🤍Влюбись🤍 откроет перед вами тайны совместимости с вашим партнером, "
